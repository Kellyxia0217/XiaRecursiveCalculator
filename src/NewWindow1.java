...
public class NewWindow1 implements ActionListener, KeyListener {
    ...
    NewWindow1() {
        ...
        textField1.setBounds(455,92,100,20);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (a.equals("Submit")) {
            ...
            if (text1.equals("m")) {
                textArea.append(String.valueOf(s1.GeometricSequenceA()));
            } else if (text1.equals("d")) {
                textArea.append(String.valueOf(s1.GeometricSequenceB()));
            }
